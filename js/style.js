...
function offButton() {
  console.log("off");
  on.classList.remove("driver-toggle-btn-active");
  off.classList.add("driver-toggle-btn-active");
}

function onButton() {
  console.log("on");
  on.classList.add("driver-toggle-btn-active");
  off.classList.remove("driver-toggle-btn-active");
}
